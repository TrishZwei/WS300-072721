...
let lastId,
	...
	scrollItems = menuItems.map( function(){
		//map is a new array method, this is the jQuery version of it
...
clicked++; //adds 1 to our clicked
	...
	if(this.hash !== ''){
		...
		$('html, body').animate({
			...
			//this is getting called twice due to being put on two different elements, some browsers need to have this associated with html,some need the body, some will take either one. But at present for cross-browser consistency, we're doing both. Because of that, we need to know if the animation has been already activated.
			if(bodAnimate == 0){
				//run animation
				bodAnimate++;
